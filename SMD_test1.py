...
class SMD004():
	...
	def eOpenCOMPort(self,port=1):
		self.ser = serial.Serial(str(port), baudrate=19200, parity=serial.PARITY_ODD, timeout=0.05, stopbits=serial.STOPBITS_ONE, bytesize=serial.EIGHTBITS)
